      ...
      <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div class="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div class="max-w-3xl mx-auto text-center pb-12">
            ...
            <!-- Page title -->
            <h1 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60">{{ $t('reset.title') }}</h1>
          </div>
          ...
          <div class="max-w-sm mx-auto">
            ...
            <form>
              <div class="space-y-4">
                <div>
                  <label class="block text-sm text-slate-300 font-medium mb-1" for="email">{{ $t('reset.email') }}</label>
                  <input id="email" class="form-input w-full" type="email" :placeholder="$t('reset.email_placeholder')" required />
                </div>
              </div>
              <div class="mt-6">
                <button class="btn text-sm text-white bg-purple-500 hover:bg-purple-600 w-full shadow-xs group">
                  {{ $t('reset.button') }}<span class="tracking-normal text-purple-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                </button>
              </div>
            </form>
