    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-16 pb-12 md:pt-32 md:pb-20 border-b border-slate-800">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">{{ $t('features03.title') }}</h2>
          <p class="text-lg text-slate-400">{{ $t('features03.description') }}</p>
        </div>
